...
export const INITIAL_PRODUCTS = [
  {
    ...
    short_description:
      "Managed L3 rackmount switch with 48 gigabit ethernet ports and 4 SFP+ uplinks.",
    brand: "Cisco Systems",
  ...
  },
  {
    ...
    short_description:
      "OM4 duplex LC-LC armored multi-mode patch cord for high-density datacenters.",
    brand: "Corning Inc.",
  ...
  },
  {
    ...
    short_description:
      "Compact AI developer kit for embedded vision, IoT edge inference, and sensor networks.",
    brand: "NVIDIA Corp",
  ...
  },
  {
    ...
    short_description:
      "Double-conversion online UPS with expandable runtimes and network card.",
    brand: "APC Power",
  ...
  },
  {
    ...
    short_description:
      "Unified Threat Management secure firewall gateway for branch office and datacenters.",
    brand: "Fortinet",
    category: "Networking Systems",
    unit: "Units",
    weight: 3.2,
...
export const MOCK_SUPPLIERS = [
  {
    supplier_id: "s-1",
    company_name: "Cisco Distribution Pakistan",
    contact_person: "Salman Ahmed",
    email: "salman@cisco-pk.com",
  ...
  {
    supplier_id: "s-2",
    company_name: "Corning Cable Tech Inc.",
    contact_person: "Faisal Mehmood",
    email: "faisal@cabletech.com.pk",
  ...
  {
    supplier_id: "s-3",
    company_name: "NVIDIA Advanced Edge Ltd.",
    contact_person: "Zahid Hussain",
    email: "zahid@nvidia-edge.pk",
    phone: "+92 51 22890123",
    city: "Islamabad",
    country: "Pakistan",
...
export const MOCK_PAYMENTS = [
  {
    payment_id: "pay-1",
    customer_name: "Karachi Tech Ltd",
    amount: 1500000,
    payment_method: "JAZZCASH",
    reference_no: "JC-887192-PK",
    payment_date: "2026-07-01T11:00:00Z",
    status: "RECORDED",
  },
  {
    payment_id: "pay-2",
    customer_name: "Lahore Distributing Co",
    amount: 1368800,
    payment_method: "BANK_TRANSFER",
    reference_no: "HBL-TXN-299301",
    payment_date: "2026-06-29T10:00:00Z",
    status: "RECONCILED",
  },
  {
    payment_id: "pay-3",
    customer_name: "Islamabad Office Solutions",
    amount: 100000,
    payment_method: "EASYPAISA",
    reference_no: "EP-445610-TX",
    payment_date: "2026-06-22T16:20:00Z",
    status: "RECORDED",
  },
];
...
export const INITIAL_NOTIFICATIONS = [
  {
    ...
    message:
      "AI Edge Jetson Nano Compute Unit available quantity is 13 units (below threshold of 15).",
    severity: "WARNING",
  ...
  },
  {
    ...
    message:
      "Invoice INV-2026-00004 is overdue by 11 days. Customer credit risk limit breach imminent.",
    severity: "CRITICAL",
  ...
  {
    notification_id: "n-3",
    title: "System Capacity Overstock",
    message:
      "High-Speed Fiber Optic Cable 100m quantity at Karachi Depot exceeded overstock buffer.",
    severity: "INFO",
...
export const MOCK_AUDIT_LOGS = [
  {
    ...
    performed_by: "Asim Raza (Inventory Manager)",
    notes:
      "Manually updated stock quantity at Karachi Central Depot (+15 units)",
    created_at: "2026-07-01T12:00:00Z",
  },
  {
    audit_id: "aud-2",
    ...
    performed_by: "Saif Shahzad (Super Admin)",
    notes:
      "Updated product status of UPS Smart Backup Battery 10kVA to DISCONTINUED.",
