...
export default function AdminPortal({ onLogout }) {
  ...
  useEffect(() => {
    ...
    // Chat state now lives inside AdminChatbotWidget, which keeps its own conversation
    // across tab switches -- resetting it from here would also discard the history.
    setPageLoading(true);
    ...
    /* @__PURE__ */ jsxs("div", {
      ...
      /* @__PURE__ */ jsx("main", {
        ...
        , /* @__PURE__ */ jsxs("div", {
          ...
          children: [
            /* @__PURE__ */ jsx(AdminChatbotWidget, {
              currentUser,
              onProductCreated: addNewProduct,
