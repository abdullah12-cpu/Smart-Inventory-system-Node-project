      ...
      return /* @__PURE__ */ jsxs("div", {
        ...
        /* @__PURE__ */ jsx("div", {
          ...
          /* @__PURE__ */ jsxs("table", {
            ...
            /* @__PURE__ */ jsx("tbody", {
                className: "bg-white divide-y divide-slate-100", children:
...
export default function AdminPortal({ onLogout }) {
  ...
  const [activeAdminQuote, setActiveAdminQuote] = useState(null);
  const [adminQuoteModalOpen, setAdminQuoteModalOpen] = useState(false);
  const [adminCounterUnitPrice, setAdminCounterUnitPrice] = useState("");
  const [adminCounterNotes, setAdminCounterNotes] = useState("");
  const [adminCounterError, setAdminCounterError] = useState("");
        ...
        /* @__PURE__ */ jsx(AnimatePresence, {
                ...
                className: "page-container animate-cross-fade flex flex-col gap-6", children: [
                  /* @__PURE__ */ jsxs("div", {
                    children: [
                      /* @__PURE__ */ jsx("h1", {
                        className: "text-2xl font-bold text-[#0F172A]",
                        style: { fontFamily: "Outfit, sans-serif" },
                        children: "Automated B2B Billing & Invoices"
                      }),
                      /* @__PURE__ */ jsx(motion.div, {
                        initial: shouldReduceMotion ? { width: "100%" } : { width: 0 },
                        animate: { width: "100%" },
                      ...
                      /* @__PURE__ */ jsx("p", { className: "text-xs text-[#64748B] mt-1.5", children: "History of invoices automatically generated upon Admin approval of wholesale orders and quotation requests." })
                    ]
                  }),
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "bg-white border border-[#E2E8F0] rounded-xl p-4 shadow-sm flex items-center justify-between", children: [
                      /* @__PURE__ */ jsxs("div", { children: [
                        ...
                        /* @__PURE__ */ jsxs("span", { className: "text-[10px] text-amber-600 font-semibold", children: [`${invoices.filter(i => i.status !== "PAID").length} open invoices`] })
                      ] }),
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "bg-white border border-[#E2E8F0] rounded-xl p-4 shadow-sm flex items-center justify-between", children: [
                      /* @__PURE__ */ jsxs("div", { children: [
                        ...
                        /* @__PURE__ */ jsxs("span", { className: "text-[10px] text-emerald-600 font-semibold", children: [`${formatCurrency(invoices.filter(i => i.status === "PAID").reduce((acc, i) => acc + Number(i.total_amount || 0), 0))} settled`] })
                      ] }),
                      /* @__PURE__ */ jsx("div", { className: "p-3 bg-emerald-50 text-emerald-600 rounded-xl", children: /* @__PURE__ */ jsx(Check, { size: 22 }) })
                    ] })
                  ] }),
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "bg-white border border-[#E2E8F0] rounded-xl p-4 shadow-sm flex flex-wrap gap-4 items-center justify-between", children: [
                    /* @__PURE__ */ jsxs("div", { className: "relative flex-1 max-w-sm", children: [
                      ...
                      /* @__PURE__ */ jsx("input", {
                        ...
                        placeholder: "Search by invoice #, product, or distributor...",
                        value: invSearch,
                  ...
                  /* @__PURE__ */ jsx("div", { className: "bg-white border border-[#E2E8F0] rounded-xl shadow-sm overflow-hidden flex flex-col", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse text-xs", children: [
                    /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "bg-[#F8FAFC] border-b border-[#E2E8F0]", children: [
                      ...
                      /* @__PURE__ */ jsx("th", { className: "px-6 py-3.5 text-[11px] font-bold text-[#64748B] uppercase", children: "Distributor / Partner" }),
                      /* @__PURE__ */ jsx("th", { className: "px-6 py-3.5 text-[11px] font-bold text-[#64748B] uppercase text-right", children: "Total Amount" }),
                      /* @__PURE__ */ jsx("th", { className: "px-6 py-3.5 text-[11px] font-bold text-[#64748B] uppercase", children: "Issue Date" }),
                    ...
                    /* @__PURE__ */ jsx("tbody", { children: (() => {
                      const filteredInvoices = invoices.filter((inv) => {
                        ...
                        const matchSearch = !invSearch ||
                          ...
                          (inv.product_name && inv.product_name.toLowerCase().includes(q)) ||
                          (inv.items_summary && inv.items_summary.toLowerCase().includes(q)) ||
                          (inv.distributor_name && inv.distributor_name.toLowerCase().includes(q)) ||
                          (inv.customer_email && inv.customer_email.toLowerCase().includes(q));
                        const matchStatus = invStatusFilter === "all" || (inv.status || "UNPAID").toUpperCase() === invStatusFilter.toUpperCase();
                        return matchSearch && matchStatus;
                      });
                      if (filteredInvoices.length === 0) {
                        return /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 7, className: "text-center py-10 text-xs text-[#94A3B8] font-medium", children: "No invoices generated matching search & filter." }) });
                      }
                      return filteredInvoices.map((inv) => /* @__PURE__ */ jsxs("tr", { className: "border-b border-[#E2E8F0] hover:bg-slate-50 transition-colors", children: [
                        /* @__PURE__ */ jsxs("td", { className: "px-6 py-4 font-bold text-[#0F172A]", children: [
                          inv.invoice_number,
                          inv.order_number && /* @__PURE__ */ jsxs("div", { className: "text-[10px] text-[#64748B] font-normal", children: ["Order: ", inv.order_number] })
                        ] }),
                        /* @__PURE__ */ jsx("td", { className: "px-6 py-4 font-semibold text-[#334155] max-w-xs truncate", children: (() => {
                        ...
                        /* @__PURE__ */ jsx("td", { className: "px-6 py-4 text-[#64748B]", children: formatDate(inv.due_date) }),
                        /* @__PURE__ */ jsx("td", { className: "px-6 py-4 text-center", children: /* @__PURE__ */ jsx("span", {
                          className: `px-2.5 py-1 rounded-full text-[10px] font-extrabold uppercase border ${
                            (inv.status || "UNPAID") === "PAID"
                              ? "bg-emerald-50 text-emerald-700 border-emerald-200"
                              : (inv.status || "UNPAID") === "OVERDUE"
                              ? "bg-rose-50 text-rose-700 border-rose-200"
                              : "bg-amber-50 text-amber-700 border-amber-200"
                          }`,
                          children: inv.status || "UNPAID"
                        }) })
                      ] }, inv.invoice_id));
                    })() })
                  ] }) }) })
                            ...
                            "tr",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ jsxs("td", { className: "px-6 py-3.5", children: [
                                  /* @__PURE__ */ jsx("div", { className: "font-bold text-[#0F172A]", children: q.quotation_number }),
                                  /* @__PURE__ */ jsx("div", { className: "text-[10px] text-[#64748B]", children: q.customer_email || "partner@commerceiq.com" })
                                ] }),
                                /* @__PURE__ */ jsxs("td", { className: "px-6 py-3.5", children: [
                                ...
                                /* @__PURE__ */ jsx("td", { className: "px-6 py-3.5", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-0.5", children: [
                                  /* @__PURE__ */ jsx(Badge, {
                                    text: q.status,
                                    variant: q.status === "APPROVED" || q.status === "ACCEPTED" ? "success" : (q.status === "COUNTER_OFFER_RECEIVED" || q.status === "NEGOTIATING") ? "warning" : q.status === "REJECTED" ? "danger" : "neutral"
                                  }),
                                ...
                                /* @__PURE__ */ jsxs("td", { className: "px-6 py-3.5 text-center flex justify-center gap-1.5", children: [
                                  (q.status !== "APPROVED" && q.status !== "ACCEPTED" && q.status !== "REJECTED") && /* @__PURE__ */ jsxs(Fragment, { children: [
                                    /* @__PURE__ */ jsx("button", {
                                      onClick: async () => {
                                        if (confirm(`Approve quotation ${q.quotation_number} for Rs ${Number(q.total_amount).toLocaleString()}?`)) {
                                    ...
                                    /* @__PURE__ */ jsx("button", {
                                      onClick: async () => {
                                        if (confirm(`Reject quotation ${q.quotation_number}?`)) {
          ...
          /* @__PURE__ */ jsxs("div", {
            ...
            /* @__PURE__ */ jsxs(motion.div, {
              ...
              /* @__PURE__ */ jsxs("div", {
                  className: "bg-white border border-[#E2E8F0] rounded-2xl p-6 shadow-sm flex flex-col gap-4", children: [
                /* @__PURE__ */ jsx("h3", { className: "text-sm font-bold text-[#0F172A] border-b border-[#F1F5F9] pb-3", children: "Pending Registration Requests" }),
                    (() => {
                      ...
                      return /* @__PURE__ */ jsx("div", {
                        className: "flex flex-col gap-3", children: pending.map((dist, idx) => /* @__PURE__ */ jsxs(
                          motion.div,
                          {
              ...
              /* @__PURE__ */ jsxs("div", {
                ...
                /* @__PURE__ */ jsx("h3", { className: "text-sm font-bold text-[#0F172A] border-b border-[#F1F5F9] pb-3", children: "Registered Distributors" }),
                    (() => {
                      ...
                      return /* @__PURE__ */ jsx("div", {
                        className: "flex flex-col gap-3", children: activeDists.map((dist, idx) => /* @__PURE__ */ jsxs(
                          motion.div,
                          {
                            initial: shouldReduceMotion ? {} : { opacity: 0, y: 15 },
                            animate: { opacity: 1, y: 0 },
              ...
              /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                  ...
                  children: [
                    ...
                    className: "relative", children: [
                        /* @__PURE__ */ jsx("div", {
                      className: "w-7 h-7 rounded-full bg-gradient-to-tr from-indigo-500 to-violet-500 flex items-center justify-center shadow-md", children:
              ...
              /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                  chatMessages.length === 1 && chatMessages[0].sender === "ai" ? (
                    ...
                    children: [
                        /* @__PURE__ */ jsxs("div", {
                      className: "relative my-2", children: [
                          /* @__PURE__ */ jsx("div", {
                        className: "w-14 h-14 rounded-2xl bg-gradient-to-tr from-[#4F46E5] to-[#818CF8] flex items-center justify-center shadow-lg relative z-10", children:
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxs("div", {
                      className: "w-full space-y-2 pt-2 text-left max-h-52 overflow-y-auto pr-1", children: [
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsx("div", {
                        className: "pt-1 pb-0.5", children:
                    ...
                    chatMessages.slice(1).map((msg, i) => /* @__PURE__ */ jsx(motion.div, {
                      ...
                      children: /* @__PURE__ */ jsxs("div", {
                        ...
                        children: [
                          msg.image && /* @__PURE__ */ jsx("div", {
                            className: "mb-2 rounded-lg overflow-hidden max-h-32 border border-[#FFFFFF]/25 bg-black/10", children:
              ...
              /* @__PURE__ */ jsxs("form", {
                ...
                children: [
                  chatAttachedImage && /* @__PURE__ */ jsxs("div", {
                    className: "relative w-14 h-14 rounded-lg border border-[#E2E8F0] overflow-hidden bg-slate-50 flex-shrink-0 mb-1 shadow-sm group", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", {
                    className: "flex gap-2 w-full items-center", children: [
                    /* @__PURE__ */ jsxs("label", {
            ...
            shippingOrderId && (() => {
              ...
              return /* @__PURE__ */ jsx("div", {
                ...
                children: /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                  /* @__PURE__ */ jsxs("div", {
                    className: "px-5 py-4 border-b border-[#E2E8F0] flex justify-between items-center bg-slate-50/50", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", {
                    className: "p-5 flex flex-col gap-4 text-xs", children: [
                    /* @__PURE__ */ jsxs("div", {
                      children: [
                    ...
                    /* @__PURE__ */ jsxs("div", {
                      className: "bg-slate-50 p-2.5 rounded-lg border border-slate-100", children: [
                      /* @__PURE__ */ jsx("span", { className: "text-[10px] text-slate-500 font-bold block mb-1.5 uppercase", children: "Items in Order" }),
                        (orderWhItems || []).map((item, idx) => {
                          ...
                          return /* @__PURE__ */ jsxs("div", {
                            className: "flex justify-between items-center py-1 border-b border-slate-100 last:border-0", children: [
                          ...
                          /* @__PURE__ */ jsxs("span", {
                              className: `font-bold ${hasSufficient ? "text-emerald-600" : "text-rose-500"}`, children: [
                                "Stock: ",
                    ...
                    /* @__PURE__ */ jsxs("div", {
                      className: "flex gap-2.5 pt-2", children: [
                      /* @__PURE__ */ jsx("button", {
