...
import DistributorChatbotWidget from "@/components/DistributorChatbotWidget";
...
export default function DistributorPortal({ onLogout }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex h-screen bg-[#F8FAFC] overflow-hidden text-xs", children: [
    ...
    /* @__PURE__ */ jsx(
      ...
      /* Distributor Copilot Widget -- voice-enabled (Urdu TTS/STT), scoped to this
         distributor's own account (orders, quotations, invoices, ledger) */
      /* @__PURE__ */ jsx(DistributorChatbotWidget, {
        currentUser,
        products,
